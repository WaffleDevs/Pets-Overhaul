...
namespace PetsOverhaul.PetEffects.ThoriumMod
{
    ...
    sealed public class AlienResearchNotes : GlobalItem
    {
        public override bool AppliesToEntity(Item entity, bool lateInstantiation)
        {
            ...
            if(!ModManager.Mods["ThoriumMod"].InternalNameToModdedItemId.ContainsKey("AlienResearchNotes")) return false;

            return entity.type == ModManager.Mods["ThoriumMod"].InternalNameToModdedItemId["AlienResearchNotes"];
        }
