...
{
    sealed public class Fly : ModPlayer
    {
    ...
    sealed public class RottenMeat : GlobalItem
    {
        public override bool AppliesToEntity(Item entity, bool lateInstantiation)
        {
            ...
            if(!ModManager.ThoriumMod.InternalNameToModdedItemId.ContainsKey("RottenMeat")) return false;
        ...
        public override void ModifyTooltips(Item item, List<TooltipLine> tooltips)
        {
            ...
            tooltips.Add(new(Mod, "Tooltip0", "Unimplemented"/*Language.GetTextValue("Mods.PetsOverhaul.RottenMeatTooltips.RottenMeat")*/
