...
namespace PetsOverhaul.PetEffects.ThoriumMod
{
    ...
    sealed public class AromaticBiscuit : GlobalItem
    {
        public override bool AppliesToEntity(Item entity, bool lateInstantiation)
        {
            ...
            if(!ModManager.Mods["ThoriumMod"].InternalNameToModdedItemId.ContainsKey("AromaticBiscuit")) return false;

            return entity.type == ModManager.Mods["ThoriumMod"].InternalNameToModdedItemId["AromaticBiscuit"];
        }
