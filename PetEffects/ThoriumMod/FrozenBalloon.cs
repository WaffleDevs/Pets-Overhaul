...
namespace PetsOverhaul.PetEffects.ThoriumMod
{
    ...
    sealed public class FrozenBalloonItem : GlobalItem
    {
        public override bool AppliesToEntity(Item entity, bool lateInstantiation)
        {
            ...
            if(!ModManager.Mods["ThoriumMod"].InternalNameToModdedItemId.ContainsKey("FrozenBalloon")) return false;

            return entity.type == ModManager.Mods["ThoriumMod"].InternalNameToModdedItemId["FrozenBalloon"];
        }
