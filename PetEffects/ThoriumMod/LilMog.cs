...
{
    sealed public class LilMog : ModPlayer
    {
    ...
    sealed public class DelectableNut : GlobalItem
    {
        public override bool AppliesToEntity(Item entity, bool lateInstantiation)
        {
            ...
            if(!ModManager.ThoriumMod.InternalNameToModdedItemId.ContainsKey("DelectableNut")) return false;
        ...
        public override void ModifyTooltips(Item item, List<TooltipLine> tooltips)
        {
            ...
            tooltips.Add(new(Mod, "Tooltip0", "Unimplemented"/*Language.GetTextValue("Mods.PetsOverhaul.DelectableNutTooltips.DelectableNut")*/
