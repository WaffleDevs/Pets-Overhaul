...
namespace PetsOverhaul.PetEffects.ThoriumMod
{
    ...
    sealed public class BalloonBall : GlobalItem
    {
        public override bool AppliesToEntity(Item entity, bool lateInstantiation)
        {
            ...
            if(!ModManager.Mods["ThoriumMod"].InternalNameToModdedItemId.ContainsKey("BalloonBall")) return false;

            return entity.type == ModManager.Mods["ThoriumMod"].InternalNameToModdedItemId["BalloonBall"];
        }
