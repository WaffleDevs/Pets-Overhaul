...
namespace PetsOverhaul.PetEffects.ThoriumMod
{
    ...
    sealed public class SuspiciousMoisturizerBottle : GlobalItem
    {
        public override bool AppliesToEntity(Item entity, bool lateInstantiation)
        {
            ...
            if(!ModManager.Mods["ThoriumMod"].InternalNameToModdedItemId.ContainsKey("SuspiciousMoisturizerBottle")) return false;

            return entity.type == ModManager.Mods["ThoriumMod"].InternalNameToModdedItemId["SuspiciousMoisturizerBottle"];
        }
