...
namespace PetsOverhaul.PetEffects.ThoriumMod
{
    ...
    sealed public class AncientCheeseBlock : GlobalItem
    {
        public override bool AppliesToEntity(Item entity, bool lateInstantiation)
        {
            ...
            if(!ModManager.Mods["ThoriumMod"].InternalNameToModdedItemId.ContainsKey("AncientCheeseBlock")) return false;

            return entity.type == ModManager.Mods["ThoriumMod"].InternalNameToModdedItemId["AncientCheeseBlock"];
        }
