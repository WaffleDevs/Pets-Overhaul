...
namespace PetsOverhaul.PetEffects.ThoriumMod
{
    ...
    sealed public class ForgottenLetter : GlobalItem
    {
        public override bool AppliesToEntity(Item entity, bool lateInstantiation)
        {
            ...
            if(!ModManager.Mods["ThoriumMod"].InternalNameToModdedItemId.ContainsKey("ForgottenLetter")) return false;

            return entity.type == ModManager.Mods["ThoriumMod"].InternalNameToModdedItemId["ForgottenLetter"];
        }
