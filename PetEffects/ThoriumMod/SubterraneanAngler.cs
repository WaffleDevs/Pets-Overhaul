...
namespace PetsOverhaul.PetEffects.ThoriumMod
{
    ...
    sealed public class SubterraneanBulb : GlobalItem
    {
        public override bool AppliesToEntity(Item entity, bool lateInstantiation)
        {
            ...
            if(!ModManager.Mods["ThoriumMod"].InternalNameToModdedItemId.ContainsKey("SubterraneanBulb")) return false;

            return entity.type == ModManager.Mods["ThoriumMod"].InternalNameToModdedItemId["SubterraneanBulb"];
        }
