...
{
    sealed public class SubterraneanAngler : ModPlayer
    {
    ...
    sealed public class SubterraneanBulb : GlobalItem
    {
        public override bool AppliesToEntity(Item entity, bool lateInstantiation)
        {
            ...
            if(!ModManager.ThoriumMod.InternalNameToModdedItemId.ContainsKey("SubterraneanBulb")) return false;
        ...
        public override void ModifyTooltips(Item item, List<TooltipLine> tooltips)
        {
            ...
            tooltips.Add(new(Mod, "Tooltip0", "Unimplemented"/*Language.GetTextValue("Mods.PetsOverhaul.SubterraneanBulbTooltips.SubterraneanBulb")*/
